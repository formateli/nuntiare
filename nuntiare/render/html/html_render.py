...
class HtmlRender(Render):
    ...
    def get_head(self, report):
        ...
        title.add_element(HtmlElement("text", None, report.definition.name))
    ...
    def get_style(self, it, ignore_list=[]):
        ...
        self.add_style_property('border-style', "{0} {1} {2} {3}".format(
                self.get_border_style_width(it.style.border_style.top), 
                self.get_border_style_width(it.style.border_style.right),
                self.get_border_style_width(it.style.border_style.bottom),
                self.get_border_style_width(it.style.border_style.left)), ignore_list,  properties)
        self.add_style_property('border-width', "{0}mm {1}mm {2}mm {3}mm".format(
                self.get_border_style_width(it.style.border_width.top), 
                self.get_border_style_width(it.style.border_width.right),
                self.get_border_style_width(it.style.border_width.bottom),
                self.get_border_style_width(it.style.border_width.left)), ignore_list,  properties)
        self.add_style_property('border-color', "{0} {1} {2} {3}".format(
                it.style.border_color.top.hex, 
                it.style.border_color.right.hex,
                it.style.border_color.bottom.hex,
                it.style.border_color.left.hex), ignore_list,  properties)
