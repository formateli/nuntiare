...
class Page(object):
    def __init__(self, report):
        self.report = report
        self.page_def = report.report_def.get_element('Page')
        
        self.height = Expression.get_value_or_default(report,self.page_def,"PageHeight",inch_2_mm(11))
        self.width = Expression.get_value_or_default(report,self.page_def,"PageWidth", inch_2_mm(8.5))
        ...
        self.margin_top = Expression.get_value_or_default(report,self.page_def,"TopMargin", 0.0)
        self.margin_left = Expression.get_value_or_default(report,self.page_def,"LeftMargin", 0.0)
        self.margin_right = Expression.get_value_or_default(report,self.page_def,"RightMargin", 0.0)
        self.margin_bottom = Expression.get_value_or_default(report,self.page_def,"BottomMargin", 0.0)

        self.columns = Expression.get_value_or_default(report,self.page_def,"Columns", 1)
        self.column_spacing = Expression.get_value_or_default(report,self.page_def,"ColumnSpacing", inch_2_mm(0.5))
...
class _SectionInfo(object):
    ...
    def get_items(self):
        self.items = PageItemsInfo(self.report, self.definition, parent=None)
        return self.items
